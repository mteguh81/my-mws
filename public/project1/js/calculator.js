document.addEventListener('DOMContentLoaded', (event) => {
    initiateCalculator(); // Memanggil fungsi untuk mengisi konten kalkulator
    initiateHeader();
});
...
initiateHeader = (wrapper_container) => {
    ...
    icon_menu.className = "fas fa-arrow-left icon_back";
    icon_menu.id = "icon_menu";

    link_back.appendChild(icon_menu);

    wrapper_menu.appendChild(link_back);
    wrapper_menu.appendChild(image_menu);

    document.body.insertBefore(wrapper_menu, document.body.firstChild);
}

initiateCalculator = () => {
    var wrapper_parent = document.createElement("div");
    wrapper_parent.className = "calc_parent";
    ...
    var btn_clear_entry = document.createElement("a");
    ...
    wrapper_parent.appendChild(wrapper_result);
    wrapper_parent.appendChild(wrapper_calc);
    document.body.insertBefore(wrapper_parent, document.body.firstChild);
    document.body.insertBefore(wrapper_title, wrapper_parent);
    ...
    var assignOperator = function() {
        ...
        if (operator) {
            calculateNumber("trigger_operator");
        }
    ...
    var calculateNumber = function(trigger_type) {
        var first_number = document.getElementById("first_number").value;
        var calc_value = document.getElementById("calc_value").innerHTML;
        var operator = document.getElementById("operator").value;
